...
namespace Whilefun.FPEKit
{
	...
	public class FPEInteractionManagerScript : MonoBehaviour
	{
		...
		public bool YBCundockFlag = false;

		[Obsolete( "Be aware that this Script features dirty hacks by Krakentanz. Do not use as is in production!!" )]
		private void HandleYBCStuff()
		{
			if( YBCundockFlag )
			{
				if( currentDock && !examiningObject)
				{
