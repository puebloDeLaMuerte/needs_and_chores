...
public class NeemotixBase : MonoBehaviour
{
	...
	protected static Color urgendColor			= new Color(1, 1, 1);
	protected static Color unsatisfiedColor		= new Color(1, 1, 1);
	protected static Color satisfiedColor		= new Color(1, 1, 1);
	protected static Color oversatisfiedColor	= new Color(1, 1, 1);
}
